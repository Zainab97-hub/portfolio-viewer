//index.js is the main file where we will start our server
...
// Route to serve navigation.js from routes directory
app.get('/navigation.js', (req, res) => {
    res.sendFile(path.join(__dirname, 'routes', 'navigation.js'));
});
